...
# quick check of depression scores: 
...
#data_final$wtdrd1[data_final$wtdrd1== 0] <- NA (Julia: a weight of zero will pull it out of the analysis, I'm unclear what setting it to NA will do - it's probably package dependent)
...
#Recoding postpartum status  

# table(data_final$rhq197)
# data_final$rhq197[data_final$rhq197> 12] <- NA
# table(data_final$rhq197)
# data_final$rhq197[data_final$rhq197< 12] <- 1
# table(data_final$rhq197)
# data_final$rhq197[data_final$rhq197== 12] <- 1
# table(data_final$rhq197)
# #data_final$rhq197[data_final$rhq197> 12] <- 2  # what is this doing? 
# table(data_final$rhq197)
